...
class MapViewModel: ObservableObject {
    ...
    func createMapScene(mapName: String) -> SCNScene {
        ...
        if let mapNode = loadUSDZModel(named: selectedMap.name){
            ...
            let hallway_node_31 = createSphereNode(position: SCNVector3(x: 275.00000, y: 290.00000, z: 1))
            ...
            let hallway_node_47 = createSphereNode(position: SCNVector3(x: 33.65788, y: 135.05455, z: 1))
